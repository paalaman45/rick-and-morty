<template>
  <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Rick and Morty Universe</h2>
      <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">The Ultimate Rick and Morty Companion, Wubba Lubba Dub Dub!</p>
    </div>
  </div>
</template>
